...
*/
/*
 * $Source: f:/miner/source/main/editor/rcs/texpage.c $
 * $Revision: 1.14 $
 * $Author: john $
 * $Date: 1995/01/14 19:18:02 $
 * 
...
static char rcsid[] = "$Id: texpage.c 1.14 1995/01/14 19:18:02 john Exp $";
...
texpage_show_current()
{
	...
	gr_ubitmap(0,0, Textures[CurrentTexture]);
